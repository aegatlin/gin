...
export const react = {
    name: 'react',
    description: 'React code generator. All code assumes TypeScript and Tailwind.',
    subCommands: [
        {
            name: 'core',
            actions: [
        ...
        },
        {
            ...
            options: [
                {
                    flags: '--path <value>',
                    description: 'path to file (including name, e.g., ./custom/path/my-card.tsx',
        ...
        },
        {
            ...
            options: [
                {
                    flags: '--path <value>',
                    description: 'path to file (including name, e.g., ./custom/path/my-page.tsx',
