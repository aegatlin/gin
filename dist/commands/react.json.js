...
export const react = {
    name: 'react',
    description: 'React generators. Currently, all code assumes TypeScript and Tailwind.',
    subCommands: [
        {
            name: 'core',
            actions: [
                {
                    ...
                    action: ({ name, path }) => {
                        const urlPath = 'https://raw.githubusercontent.com/aegatlin/core/main/src/core';
